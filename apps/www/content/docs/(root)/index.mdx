...
Huge thanks to **shadcn/ui** and the registry layout that inspired this project, and to the **Vercel team—especially the AI SDK team**—for making modern AI interfaces possible.
...
Sidekick is built around the following principles:
...
_In a typical library, if you need to change a button’s behavior, you have to override styles or wrap the component. With Sidekick, you simply edit the component code directly._
...
<Accordion collapsible>
  <AccordionItem value="faq-1" className="border-none">
    ...
    <AccordionContent>
      <p>
        Sidekick follows a headless component architecture. This means the core
...
Every component in Sidekick shares a common, composable interface. **If a component does not exist, we bring it in, make it composable, and adjust its style to match and work with the rest of the design system.**
...
Sidekick is also a code distribution system. It defines a schema for components and a CLI to distribute them.
