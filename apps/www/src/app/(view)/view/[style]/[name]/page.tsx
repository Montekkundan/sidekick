...
import { getStyle, legacyStyles } from "@/registry/_legacy-styles";
...
> = {
  ...
  "prompt-input-01": () =>
    import("@/registry/new-york/blocks/prompt-input-01/page"),
  "prompt-input-02": () =>
    import("@/registry/new-york/blocks/prompt-input-02/page"),
  "prompt-input-03": () =>
    import("@/registry/new-york/blocks/prompt-input-03/page"),
};
